...
export interface paths {
    ...
    "/api/v1/deployment-verifications": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** 读取 Deployment Acceptance invocation 历史 */
        get: operations["listDeploymentVerifications"];
        put?: never;
        /**
    ...
    "/api/v1/deployment-verifications/{invocationId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** 读取不可变 manifest、items、append-only results/conflicts/drift 与 final receipt */
        get: operations["getDeploymentVerification"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/deployment-verifications/{invocationId}/cancel": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * 停止未开始/运行中的 item，并按已观测到的真实结果 finalize（Admin）
         * @description 不存在可变 invocation status；取消先追加 `operator_cancelled/not_run` item result，再等待已派发工作形成终态并写唯一 receipt。已 finalization 的 invocation 幂等返回原 receipt。
         */
        post: operations["cancelDeploymentVerification"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/deployment-verifications/{invocationId}/helper-request": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * 导出绑定该 invocation manifest 的不可变停机 helper request（Admin）
         * @description request 只含非秘密 subject、item 与 digest；不得包含产品 Session、Connection 或 Credential。相同 invocation 重读必须返回相同 requestDigest。
         */
        get: operations["exportDeploymentVerificationHelperRequest"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/deployment-verifications/{invocationId}/helper-reports": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * 导入停机 helper report 并追加绑定 item results（Admin）
         * @description Quoin 必须重验 invocationId、manifestDigest、requestDigest、release subject、每项 inputDigest 与 evidence digest；同 reportDigest 幂等，不同结果形成 verifier conflict，已 finalization 后拒绝迟到导入。
         */
        post: operations["importDeploymentVerificationHelperReport"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/deployment-verifications/{invocationId}/observations": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        /** @description 其它输入全部由服务端从当前 release、deployment config、public Origin 与数据库对象集合机械发现；普通用户不填写内部 locator。 */
        StartDeploymentVerificationRequest: components["schemas"]["CommandRequest"];
        /** @description 不含可变 invocation status；是否 finalization 只由 receipt 是否存在表达。 */
        DeploymentVerificationSummary: {
            ...
            startedAt: components["schemas"]["Timestamp"];
            /** @description startedAt + 8 小时，固定不续期。 */
            deadlineAt: components["schemas"]["Timestamp"];
            progress: {
                total: number;
                completed: number;
            };
            receipt?: components["schemas"]["DeploymentVerificationReceipt"];
        };
        DeploymentVerificationDetail: components["schemas"]["DeploymentVerificationSummary"] & {
            items: components["schemas"]["VerificationInvocationItem"][];
            results: components["schemas"]["VerificationItemResult"][];
            conflicts: components["schemas"]["VerificationResultConflict"][];
            subjectDrifts: components["schemas"]["VerificationSubjectDrift"][];
        };
        ...
        DeploymentVerificationReceipt: {
            ...
            canonicalArtifactId: components["schemas"]["LocatorId"];
        ...
        deploymentLocator: {
            /** @constant */
            kind: "deployment";
            releaseSubjectDigest: components["schemas"]["sha256"];
            deploymentConfigDigest: components["schemas"]["sha256"];
            publicOriginDigest: components["schemas"]["sha256"];
            /** @enum {unknown} */
            backend: "compose" | "kubernetes";
            /** @enum {unknown} */
        ...
        connectionLocator: {
            ...
            rootBindingRevision: number;
            probeContractDigest: components["schemas"]["sha256"];
        };
        configLocator: {
            /** @constant */
            kind: "config";
            businessSystemId: components["schemas"]["positiveId"];
        ...
        requestItem: {
            ...
            cellId: components["schemas"]["identifier"];
            inputDigest: components["schemas"]["sha256"];
            typedLocator: components["schemas"]["typedLocator"];
        };
        helperRequest: {
            /** @constant */
            schemaVersion: 1;
            ...
            invocationId: components["schemas"]["positiveId"];
            manifestDigest: components["schemas"]["sha256"];
            itemSetDigest: components["schemas"]["sha256"];
            releaseSubjectDigest: components["schemas"]["sha256"];
            catalogDigest: components["schemas"]["sha256"];
            resultProfileDigest: components["schemas"]["sha256"];
            deploymentConfigDigest: components["schemas"]["sha256"];
            publicOriginDigest: components["schemas"]["sha256"];
            /** @enum {unknown} */
            backend: "compose" | "kubernetes";
        ...
        attachment: {
            ...
            sizeBytes: number;
            mediaType?: components["schemas"]["nonEmpty"];
        };
        reportItem: {
            itemId: components["schemas"]["positiveId"];
            scenarioId: components["schemas"]["scenarioId"];
            cellId: components["schemas"]["identifier"];
            inputDigest: components["schemas"]["sha256"];
            resultDigest: components["schemas"]["sha256"];
            /** @enum {unknown} */
            outcome: "passed" | "warned" | "failed";
            /** @enum {unknown} */
            category: "passed" | "functional_assertion_failed" | "cleanup_residue" | "verifier_conflict" | "subject_drift" | "environment_unavailable" | "operator_cancelled" | "infrastructure_interrupted" | "cleanup_indeterminate" | "not_run" | "verifier_invariant_violation";
            ...
            /** @enum {unknown} */
            cleanupOutcome: "clean" | "residue" | "indeterminate" | "not_run";
        ...
        helperReport: {
            ...
            /** @enum {unknown} */
            architecture: "linux/amd64" | "linux/arm64";
            helperRequestDigest: components["schemas"]["sha256"];
            startedAt: components["schemas"]["dateTime"];
            finishedAt: components["schemas"]["dateTime"];
...
export type StartDeploymentVerificationRequest = components['schemas']['StartDeploymentVerificationRequest'];
export type DeploymentVerificationSummary = components['schemas']['DeploymentVerificationSummary'];
export type DeploymentVerificationDetail = components['schemas']['DeploymentVerificationDetail'];
export type VerificationInvocationItem = components['schemas']['VerificationInvocationItem'];
export type VerificationItemResult = components['schemas']['VerificationItemResult'];
...
export type DeploymentVerificationReceipt = components['schemas']['DeploymentVerificationReceipt'];
export type SubmitVerificationObservationRequest = components['schemas']['SubmitVerificationObservationRequest'];
export type positiveId = components['schemas']['positiveId'];
export type sha256 = components['schemas']['sha256'];
export type dateTime = components['schemas']['dateTime'];
export type scenarioId = components['schemas']['scenarioId'];
...
export interface operations {
    ...
    listDeploymentVerifications: {
        ...
        requestBody?: never;
        responses: {
            /** @description Invocation manifest/receipt 摘要分页。 */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": {
                        items: components["schemas"]["DeploymentVerificationSummary"][];
                        nextCursor?: components["schemas"]["Cursor"];
                    };
                };
            };
    ...
    startDeploymentVerification: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["StartDeploymentVerificationRequest"];
            };
        };
        responses: {
            /** @description Manifest 已冻结并开始执行。 */
            202: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["DeploymentVerificationDetail"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
    ...
    getDeploymentVerification: {
        ...
        requestBody?: never;
        responses: {
            /** @description Deployment Acceptance 权威详情。 */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    cancelDeploymentVerification: {
        ...
        responses: {
            /** @description 已停止或已 finalization；返回当前详情。 */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    exportDeploymentVerificationHelperRequest: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody?: never;
        responses: {
            /** @description 可交给同发布版本 `quoin-deploy verify` 的类型化请求。 */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/yaml": components["schemas"]["helperRequest"];
                };
            };
            401: components["responses"]["Unauthorized"];
            403: components["responses"]["Forbidden"];
    ...
    importDeploymentVerificationHelperReport: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/yaml": components["schemas"]["helperReport"];
            };
        };
        responses: {
            /** @description 已幂等导入既有 report。 */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    submitDeploymentVerificationObservation: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SubmitVerificationObservationRequest"];
            };
        };
        responses: {
            /** @description typed observation 已追加。 */
            201: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["VerificationItemResult"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];

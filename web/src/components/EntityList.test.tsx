...
describe("EntityList", () => {
  it("renders configured columns as semantic Item buttons and keeps row actions separate", () => {
    const select = vi.fn();
    const action = vi.fn();
    ...
    expect(screen.getByRole("listitem")).toContainElement(screen.getByRole("button", { name: /First checkout Firingnow/ }));

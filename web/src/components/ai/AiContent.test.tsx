...
describe("AiContent", () => {
  ...
  it("converts frozen evidence references into reading-layer buttons and leaves unknown references as text", () => {
    ...
    render(<AiContent content={"见 #e-1 与 #e-9。"} evidenceIds={["e-1"]} openEvidence={openEvidence} />);
    ...
    expect(screen.queryByRole("button", { name: "#e-9" })).not.toBeInTheDocument();
  });

...
vi.mock('../../../src/features/investigation/api', () => ({ api, sourceLabel: (type: string) => type }))
vi.mock('../../../src/features/investigation/attachments/api', () => ({ attachmentCommandId: () => 'upload-command', uploadAttachment: vi.fn() }))
vi.mock('../../../src/features/investigation/tools/api', () => ({ listToolCalls: vi.fn() }))
vi.mock('../../../src/features/feedback/api', () => ({ appendFeedback: vi.fn(), fetchFeedback: vi.fn(), feedbackValueLabels: {} }))
vi.mock('../../../src/features/knowledge/api', () => ({ api: { createMessageCandidate: vi.fn() } }))

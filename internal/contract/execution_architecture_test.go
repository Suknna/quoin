...
var executionBaseline = []executionBaselineEntry{
	{Path: "internal/quoin/app/browser_exploration.go", Symbol: "app.(*RuntimeService).closeRejectedExplorationStart", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/app/browser_exploration.go", Symbol: "app.(*RuntimeService).handleBrowserExplorationActionResult", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/app/browser_exploration.go", Symbol: "app.(*RuntimeService).handleBrowserExplorationTerminalClaim", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/app/browser_exploration.go", Symbol: "app.(*RuntimeService).handleExplorationCompletion", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/app/browser_exploration.go", Symbol: "app.(*RuntimeService).persistTerminalExplorationResult", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/attempt/recovery.go", Symbol: "attempt.(*Service).RenewLeaseForBoot", Rule: "sql_write_exec", Class: "telemetry", Planned: "stage5"},
	{Path: "internal/quoin/bootstrap/database.go", Symbol: "bootstrap.OpenDatabase", Rule: "sql_open", Class: "lowlevel", Planned: "stage1"},
	{Path: "internal/quoin/bootstrap/database.go", Symbol: "bootstrap.OpenMigrationDatabase", Rule: "sql_open", Class: "lowlevel", Planned: "stage1"},
	{Path: "internal/quoin/bootstrap/database.go", Symbol: "bootstrap.PeekHasUsers", Rule: "sql_open", Class: "lowlevel", Planned: "stage1"},
	{Path: "internal/quoin/bootstrap/database.go", Symbol: "bootstrap.PeekSchemaState", Rule: "sql_open", Class: "lowlevel", Planned: "stage1"},
	{Path: "internal/quoin/bootstrap/database.go", Symbol: "bootstrap.initializeDatabase", Rule: "tx_control_sql", Class: "lowlevel", Planned: "stage1"},
	{Path: "internal/quoin/browser/boot.go", Symbol: "browser.(*Service).InterruptForQuoinRestart", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/boot.go", Symbol: "browser.(*Service).InterruptForQuoinRestart", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/boot.go", Symbol: "browser.(*Service).InterruptMissingPhysicalOperations", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/boot.go", Symbol: "browser.(*Service).InterruptMissingPhysicalOperations", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/boot.go", Symbol: "browser.(*Service).InterruptOldBootOperations", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/boot.go", Symbol: "browser.(*Service).InterruptOldBootOperations", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/boot.go", Symbol: "browser.downgradeInterruptedExplorationClaims", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/boot.go", Symbol: "browser.sealInterruptedExplorationActions", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/completion.go", Symbol: "browser.(*Service).HandleCompletion", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/completion.go", Symbol: "browser.(*Service).HandleCompletion", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/inventory.go", Symbol: "browser.(*Service).ReconcileInventory", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/inventory.go", Symbol: "browser.(*Service).ReconcileInventory", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/publish.go", Symbol: "browser.(*Service).HandlePublishRejected", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/publish.go", Symbol: "browser.(*Service).HandlePublishRejected", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/publish.go", Symbol: "browser.(*Service).HandlePublishResult", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/publish.go", Symbol: "browser.(*Service).HandlePublishResult", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/publish.go", Symbol: "browser.(*Service).HandlePublishUnauthenticated", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/publish.go", Symbol: "browser.(*Service).HandlePublishUnauthenticated", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/reconnect.go", Symbol: "browser.(*Service).AwaitReconnect", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/reconnect.go", Symbol: "browser.(*Service).AwaitReconnect", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/reconnect.go", Symbol: "browser.(*Service).ExpireReconnect", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/reconnect.go", Symbol: "browser.(*Service).ResumeReconnect", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/runtime.go", Symbol: "browser.(*Service).HandleStartAck", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/runtime.go", Symbol: "browser.(*Service).HandleStartAck", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/runtime.go", Symbol: "browser.(*Service).prepareDispatch", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/runtime.go", Symbol: "browser.(*Service).prepareDispatch", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/runtime.go", Symbol: "browser.(*Service).preparePublish", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/service.go", Symbol: "browser.(*Service).startManualLogin", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/service.go", Symbol: "browser.(*Service).startManualLogin", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/service.go", Symbol: "browser.recordCommand", Rule: "audit_insert", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/standalone.go", Symbol: "browser.(*Service).ConfigureStandalone", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/standalone.go", Symbol: "browser.(*Service).ConfigureStandalone", Rule: "tx_control_sql", Class: "retired", Planned: "stage5"},
	{Path: "internal/quoin/browser/stop.go", Symbol: "browser.(*Service).HandleStopAck", Rule: "sql_write_exec", Class: "retired", Planned: "stage5"},

...
// The former POST resources:refresh producer is deliberately absent with the
// retired declaration-driven discovery path (ADR-0004); only retained run
// history can be read from these routes.
